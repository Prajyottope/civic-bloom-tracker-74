-- Add comprehensive Indian states, districts, and sub-districts data
-- Clear existing location data first
TRUNCATE TABLE public.locations;

-- Add exact_location field to issues table for user-written location details
ALTER TABLE public.issues ADD COLUMN exact_location text;

-- Insert all Indian states with major cities and districts
-- Note: This is a comprehensive list of Indian states, districts, and major cities
...
('Andhra Pradesh', 'Rajahmundry', 17.0005, 81.8040, false),
...
('Madhya Pradesh', 'Gwalior', 26.2183, 78.1828, false),
('Madhya Pradesh', 'Ujjain', 23.1765, 75.7885, false),
...
('Maharashtra', 'Aurangabad', 19.8762, 75.3433, false),
('Maharashtra', 'Solapur', 17.6599, 75.9064, false),
...
('Tamil Nadu', 'Tiruchirappalli', 10.7905, 78.7047, false),
('Tamil Nadu', 'Salem', 11.6643, 78.1460, false),

-- Telangana
('Telangana', 'Hyderabad', 17.3850, 78.4867, true),
('Telangana', 'Warangal', 17.9689, 79.5941, false),
('Telangana', 'Nizamabad', 18.6725, 78.0941, false),
...
('Uttar Pradesh', 'Allahabad', 25.4358, 81.8463, false),
('Uttar Pradesh', 'Bareilly', 28.3670, 79.4304, false),

-- Uttarakhand
('Uttarakhand', 'Dehradun', 30.3165, 78.0322, false),
('Uttarakhand', 'Haridwar', 29.9457, 78.1642, false),
('Uttarakhand', 'Roorkee', 29.8543, 77.8880, false),
...
('West Bengal', 'Asansol', 23.6739, 86.9524, false),
...
('Dadra and Nagar Haveli and Daman and Diu', 'Daman', 20.4283, 72.8397, false),

('Lakshadweep', 'Kavaratti', 10.5669, 72.6420, false);